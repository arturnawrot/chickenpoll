<div class="row">
    <div class="col-md-6">
        ...
        {{--<div class="form-check">--}}
            {{--<input name="settings[]" value="results_after_voting" type="checkbox" class="checkmark" id="4" checked>--}}
            {{--<label class="form-check-label" for="4">Results after voting</label>--}}
        {{--</div>--}}
        <div class="form-check">
