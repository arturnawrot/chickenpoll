...
<meta property="og:description" content="Vote! {{ implode(', ', $poll->options) }}" />
<meta property="og:image" content="/images/web.png" />
<meta name="title" content="{{ $poll->title }}" />
<meta name="type" content="website" />
<meta name="url" content="{{ url()->full() }}" />
<meta name="description" content="Vote! {{ implode(', ', $poll->options) }}" />
...
<meta name="twitter:description" content="Vote! {{ implode(', ', $poll->options) }}" />
<meta name="twitter:image" content="h/images/web.png" />
@endsection
